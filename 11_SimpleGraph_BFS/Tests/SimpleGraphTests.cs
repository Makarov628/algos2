...
namespace AlgorithmDataStructures2Tests
{
    ...
    public class SimpleGraphTests
    {
        ...
        [Test]
        public void TestFindTwoMostDistantVertexes()
        {
            var tree = new SimpleGraph<int>(8);
            tree.AddVertex(0);
            tree.AddVertex(1);
            tree.AddVertex(2);
            tree.AddVertex(3);
            ...
            tree.RemoveVertex(0);
            Assert.That(tree.FindMaxDistanceInTree(), Is.EqualTo(3));
        ...
        public void TestFindAllCycles()
        {
            ...
            var expectedCycles = new List<List<int>>
            {
                ...
                new List<int>{1, 4, 2, 3, 1},
                new List<int>{1, 3, 2, 1},
                new List<int>{1, 2, 3, 1},
                new List<int>{1, 4, 2, 1},
                new List<int>{1, 2, 4, 1},
                new List<int>{3, 2, 4, 1, 3},
                new List<int>{3, 1, 4, 2, 3},
                new List<int>{3, 2, 1, 3},
                new List<int>{3, 1, 2, 3},
                new List<int>{2, 4, 1, 3, 2},
                new List<int>{2, 3, 1, 4, 2},
                new List<int>{2, 1, 4, 2},
                new List<int>{2, 4, 1, 2},
                new List<int>{2, 1, 3, 2},
                new List<int>{2, 3, 1, 2},
                new List<int>{4, 1, 3, 2, 4},
                new List<int>{4, 2, 3, 1, 4},
                new List<int>{4, 1, 2, 4},
                new List<int>{4, 2, 1, 4},
            };

            var resultCycles = graph.FindAllCycles();

            Assert.That(resultCycles, Is.EquivalentTo(expectedCycles));
        }
    }
}
